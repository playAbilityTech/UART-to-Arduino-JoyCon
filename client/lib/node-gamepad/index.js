...
Gamepad.prototype._send = function(data) {
    ...
    this._usb.write(bytes);
  }

Gamepad.prototype.setPlayerLEDs = function(value) {
...
Gamepad.prototype.setInputReportMode = function(value) {
  const bytes = new Array(0x40).fill(0);
  bytes[0] = 0x01;
  bytes[10] = 0x03;
  bytes[11] = value;
